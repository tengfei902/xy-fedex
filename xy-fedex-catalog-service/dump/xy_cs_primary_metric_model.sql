...
--
-- Table structure for table `primary_metric_model`
--

DROP TABLE IF EXISTS `primary_metric_model`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `primary_metric_model` (
...
--
-- Dumping data for table `primary_metric_model`
--

LOCK TABLES `primary_metric_model` WRITE;
/*!40000 ALTER TABLE `primary_metric_model` DISABLE KEYS */;
/*!40000 ALTER TABLE `primary_metric_model` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-07-22  0:07:20
