...
public class ModelTableRelationPO implements Serializable {
    private Long id;
    ...
    public boolean equals(Object that) {
        ...
        ModelTableRelationPO other = (ModelTableRelationPO) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getModelId() == null ? other.getModelId() == null : this.getModelId().equals(other.getModelId()))
            && (this.getDsnId() == null ? other.getDsnId() == null : this.getDsnId().equals(other.getDsnId()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getDsnId() == null) ? 0 : getDsnId().hashCode());
